...
echo 'source ~/.vimrc.local.d/funtions.vim' >> ~/.vimrc.local
...
echo 'let g:spf13_bundle_groups=['general', 'neocomplcache', 'programming', 'python', 'javascript', 'html']' >> ~/.vimrc.bundles.local
echo 'Budnle 'ZoomWin'' >> ~/.vimrc.bundles.local
